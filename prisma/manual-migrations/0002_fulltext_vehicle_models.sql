...
-- │                                                                        │
-- │ NOTE: This is a MySQL-only migration. Local development uses SQLite    │
-- │ (file:./dev.db) where FULLTEXT is not supported — the search falls     │
-- │ back to LIKE/`contains` automatically (see car.service.js).            │
-- │                                                                        │
-- │ Apply this manually on the MySQL production database AFTER the Prisma  │
